...
function updateCoffeeView(coffeeQty) {
  ...
  coffeeCounter.innterText = coffeeQty;
}
...
function getUnlockedProducers(data) {
  ...
  data.producers.filter(producers.property === true)
...
document.getElementById("big_coffee").addEventListener("click", ClickCoffee(data)); 
